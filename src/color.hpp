...
public:
    ...
    static void update(const float dt) { va += dt; }
    ...
    static ccColor3B getChromaColor() { return hsvToRgb(cchsv(va * 180 / 1000.0f, 1.0f, 1.0f, true, true)); }

    static ccColor3B getPastelColor(int i = 0)
    {
